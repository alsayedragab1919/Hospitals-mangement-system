...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{__('Dashboard/rays.Dashboard')}}</h2><br>
						  <p class="mg-b-0">{{__('Dashboard/rays.Welcome')}} {{auth()->User()->name}}</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{__('Dashboard/rays.total')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{__('Dashboard/rays.Total_number_of_invoices_under_process')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-4 tx-12 text-white">{{__('Dashboard/rays.Total_number_of_completed_invoices')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
                        ...
                        <div class="card card-table-two">
                            ...
                            <div class="table-responsive country-table">
                                <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>{{__('Dashboard/rays.Invoice_Date')}}</th>
                                        <th>{{__('Dashboard/rays.Patient_Name')}}</th>
                                        <th>{{__('Dashboard/rays.Doctor_Name')}}</th>
                                        <th>{{__('Dashboard/rays.Required')}}</th>
                                        <th>{{__('Dashboard/rays.Invoice_Status')}}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse(\App\Models\Ray::latest()->take(5)->get() as $invoice )
                                        <tr>
                                            ...
                                            <td class="tx-right tx-medium tx-inverse">
                                                @if($invoice->case == 0)
                                                    <span class="badge badge-danger">{{__('Dashboard/rays.Under_process')}}</span>
                                                @else
                                                    <span class="badge badge-success">{{__('Dashboard/rays.Completed')}}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
