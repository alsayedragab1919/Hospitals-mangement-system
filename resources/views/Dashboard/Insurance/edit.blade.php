...
@endsection
@section('title')
    {{trans('Dashboard/insurance.modifying_insurance')}}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/insurance.modifying_insurance')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/insurance.view')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('insurance.update','test')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>{{trans('Dashboard/insurance.status')}}</label>
                                 &nbsp;
