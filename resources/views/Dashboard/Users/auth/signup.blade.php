							...
							<div class="row">
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">EAGLE <span>HOSPITA</span>L</h1></div>
										<div class="main-signup-header">
											<h2 class="text-primary">Get Started</h2>
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">{{__('Dashboard/login_tarans.select_options')}}</label>
                                                <select class="form-control" id="selectOption">
                                                    <option selected disabled>{{__('Dashboard/login_tarans.select_options')}}</option>
                                                    <option value="admin">{{__('Dashboard/login_tarans.Register_Admin')}}</option>
                                                    <option value="patient">{{__('Dashboard/login_tarans.Register_patient')}}</option>
                                                </select>
                                            </div>
