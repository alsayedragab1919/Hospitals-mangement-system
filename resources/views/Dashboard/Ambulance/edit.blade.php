...
@endsection
@section('title')
    {{trans('Dashboard/Ambulance.edit')}}
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('Dashboard/Ambulance.Ambulances')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Dashboard/Ambulance.edit')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="car_type">
                                ...
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{trans('Dashboard/Ambulance.rent')}}</option>
                            </select>
                        </div>
