    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Dashboard/patient.mesg')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('Patients.destroy', 'test') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> {{__('Dashboard/patient.mesg_1')}} </p>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success">{{__('Dashboard/doctors.del')}}</button>
                    </div>
                </form>
            </div>
        </div>
