...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{trans('Dashboard/doctors.edit')}}</h4><span
                    ...
                    <form action="{{ Route('Doctors.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{trans('Dashboard/doctors.number_of_statement')}}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="number_of_statements" value="{{$doctor->number_of_statements}}" type="number" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{ trans('Dashboard/doctors.img') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <button type="submit"
                                    class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{ trans('Dashboard/doctors.save') }}</button>
                        </div>
                    </form>
                </div>
