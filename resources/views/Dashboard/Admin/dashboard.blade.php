...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{__('Dashboard/dashboards.admin_dashboard')}}</h2>
						</div>
					</div>
...
@section('content')
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-24">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-6 pt-3 pr-3 pb-2 pt-0">
								<div class="">
                                    <h6 class="mb-3 tx-12 text-white"> <a style="color: white" href="{{url('Services')}}">{{__('Dashboard/dashboards.Number_of_Number_single_services')}}</a></h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
                                            <h5 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\Service::count()}}</h5>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
                                    <h6 class="mb-3 tx-12 text-white"><a style="color: white" href="{{url('Add_GroupServices')}}">{{__('Dashboard/dashboards.Number_of_Number_groupServices')}}</a></h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
                                    <h6 class="mb-3 tx-12 text-white"><a style="color: white" href="{{url('Doctors')}}">{{__('Dashboard/dashboards.Number_of_doctors')}}</a></h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
                                    <h6 class="mb-3 tx-12 text-white"><a style="color: white" href="{{url('Patients')}}">{{__('Dashboard/dashboards.Number_of_patients')}}</a></h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
