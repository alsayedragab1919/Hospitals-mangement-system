    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Dashboard/Recepit.delete_recepit')}}</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger">{{trans('Dashboard/Recepit.submit')}}</button>
            </div>
            </form>
        </div>
    </div>
