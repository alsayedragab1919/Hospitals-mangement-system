                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{__('Dashboard/rays.rays_doctor')}}</th>
                                                        <th>حالة الكشف</th>
                                                        <th>العمليات</th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                            ...
                                                            @if($patient_ray->doctor_id == auth()->user()->id)
                                                                @if($patient_ray->case == 0)
                                                                    <td>
                                                                        ...
                                                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" href="#Ray_delete{{$patient_ray->id}}"><i class="las la-trash"></i></a>
                                                                    </td>
                                                        ...
                                                        @include('Dashboard.doctor.invoices.edit-xray')
                                                        @include('Dashboard.doctor.invoices.Ray_deleted')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($patient_Laboratories as $patient_Laboratorie)
                                                        ...
                                                        @include('Dashboard.doctor.invoices.edit-laboratorie-conversion')
