...
@section('title')
    {{__('Dashboard/dashboards.Disclosures')}}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{__('Dashboard/dashboards.Disclosures')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('Dashboard/dashboards.invoices')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                                   ...
                                                   <td>
                                                       ...
                                                       <div class="dropdown">
                                                           ...
                                                           <div class="dropdown-menu tx-13">
                                                               ...
                                                               <a class="dropdown-item" href="#" data-toggle="modal" data-target="#x-Ray-conversion{{$invoice->id}}"><i class="text-primary fas fa-x-ray"></i>&nbsp;&nbsp;{{__('Dashboard/rays.Convert-ray')}} </a>
                                                               <a class="dropdown-item" href="#" data-toggle="modal" data-target="#Laboratorie_conversion{{$invoice->id}}"><i class="text-warning fas fa-syringe"></i>&nbsp;&nbsp;{{__('Dashboard/Laboratory.Transfer_to_laboratory')}} </a>
