...
<button class="btn btn-primary pull-right" wire:click="show_form_add" type="button">{{__('Dashboard/GroupServices.Add')}} </button><br><br>
<div class="table-responsive">
        ...
        <thead>
            <tr>
                ...
                <th>{{__('Dashboard/GroupServices.Total')}}</th>
                <th>{{__('Dashboard/GroupServices.notes')}}</th>
                <th>{{__('Dashboard/GroupServices.operation')}}</th>
            </tr>
        </thead>
        <tbody>
